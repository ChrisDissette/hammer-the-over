...
const MobileHero = () => {
  return (
    <div>
        <Box minHeight='90vh' display='flex' alignItems='center' justifyContent='center' flexDirection='column' color='primary.main'>
            ...
            <div className="typewriter-container">
                <Typography className='typed-out' variant='h2' fontWeight='bold' textAlign='center'>Hammerheads</Typography>
            </div>
